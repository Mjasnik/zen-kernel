...
void *workingset_eviction(struct page *page, struct mem_cgroup *target_memcg)
{
	...
	eviction = (eviction << WORKINGSET_SHIFT) | PageWorkingset(page);
...
void workingset_refault(struct page *page, void *shadow)
{
	...
	workingset = eviction & (BIT(WORKINGSET_SHIFT) - 1);
	eviction = (eviction >> WORKINGSET_SHIFT) << bucket_order;
	 ...
	 */
	refault_distance = (refault - eviction) & (EVICTION_MASK >> WORKINGSET_SHIFT);
...
static int __init workingset_init(void)
{
	...
	BUILD_BUG_ON(EVICTION_SHIFT < WORKINGSET_SHIFT);
	/*
	 ...
	 */
	timestamp_bits = EVICTION_SHIFT - WORKINGSET_SHIFT;
